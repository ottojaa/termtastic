...
3. Set `darkness = "<new version>"` in both consumers' version catalogs: `gradle/libs.versions.toml` (lunamux's own) **and** `../../lunicle/main/gradle/libs.versions.toml` (lunicle's).
